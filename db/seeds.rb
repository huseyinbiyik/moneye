...
# group1 = Group.create(name: "Food", icon: "https://cdn-icons-png.flaticon.com/512/2771/2771401.png", user_id: user1.id)
# group2 = Group.create(name: "Cosmetics", icon: "https://cdn-icons-png.flaticon.com/512/3501/3501241.png", user_id: user1.id)
# group3 = Group.create(name: "Sport", icon: "https://cdn-icons-png.flaticon.com/512/2270/2270989.png", user_id: user2.id)
# group4 = Group.create(name: "Health", icon: "https://cdn-icons-png.flaticon.com/512/2957/2957839.png", user_id: user2.id)

# expense1 = group1.expenses.create(name: "Bought beer #1", amount: "25", user_id: user1.id)
# expense2 = group1.expenses.create(name: "Bought jalapeno pepper #2", amount: "10", user_id: user1.id)
